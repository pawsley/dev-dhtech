...
$route['riwayat-penjualan/detail-laporan-jual/(:any)'] = 'PenRiwayat/detaillapjual/$1';
...
$route['produk-list/export-barcode/(:any)/(:any)/(:any)'] = 'PenList/exportbarcode/$1/$2/$3';
$route['detail-laba/(:num)/(:num)']='Welcome/detaillabak/$1/$2';
...
$route['detail-cb/(:num)/(:num)']='Welcome/detailcashback/$1/$2';
$route['detail-customer']='Welcome/detailcust';
$route['cabang/(:any)']='DashboardCab/dashcab/$1';
$route['detail-laba-cab/(:any)/(:num)/(:num)']='DashboardCab/detaillabak/$1/$2/$3';
$route['detail-cashback-cab/(:any)/(:num)/(:num)']='DashboardCab/detailcashback/$1/$2/$3';
$route['login']='Login';
